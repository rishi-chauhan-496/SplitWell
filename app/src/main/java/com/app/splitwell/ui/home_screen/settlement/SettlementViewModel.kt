...
import com.app.splitwell.data.remote.settlement.SettlementRequest
...
class SettlementViewModel(
    ...
    fun load(groupId: String, isRefresh: Boolean = false, silent: Boolean = false) {
    ...
    fun pollRefresh(groupId: String) {
        load(groupId, silent = true)
    }
