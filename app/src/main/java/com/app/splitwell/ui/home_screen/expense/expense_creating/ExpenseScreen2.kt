...
import com.app.splitwell.ui.components.RunningTotalBar
import com.app.splitwell.ui.components.SplitTab
import com.app.splitwell.ui.components.SplitTabRow
import com.app.splitwell.ui.home_screen.expense.ExpensePersonCard
...
fun ExpenseScreen2(
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.expense_confirm_total_question,
                stringResource(R.string.Expense_Screen_2_Title_2), state.amount),
            color = MaterialTheme.colorScheme.secondary,
            fontSize = 28.sp,
            fontWeight = FontWeight.Bold
        )
